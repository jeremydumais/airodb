...
class TestDumpConverterMethods(unittest.TestCase):
    ...
    def test_convertToJSON_TestWithOnly13FirstFieldsButValidStructure_ReturnNone(self):
        converter = DumpConverter()
        self.assertEqual(None, converter.convertToJSON("64:70:02:63:0E:86, 2019-10-30 14:31:34, 2019-10-30 14:31:56, 6, 54, WPA2, CCMP TKIP, PSK, -80, 2, 0, 0.0.0.0, 18,,"))
